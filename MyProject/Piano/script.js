...
var sheet = "";
function song1() {
    sheet = "QQWQRE QQWQTR QQIY RREW 77YRTR";
    document.getElementById("sheet").innerHTML = sheet;
}


function song2() {
    sheet = "EERTTREWQQWEEWW EERTTREWQQWEWQQ \nWWEQWEREQWEREWQW EERTTREWQQWEWQQ";
 
    document.getElementById("sheet").innerHTML = sheet;
}

function song3() {
    sheet = "QQTTYYT RREEWWQ TTRREEW TTRREEW QQTTYYT RREEWWQ";
 
    document.getElementById("sheet").innerHTML = sheet;
}

function song4() {
    sheet = "(P0P0PUOIY QEYUE6UI EP0P0PUOIY QEYUEIUY) x2\nUIOPTPOI RPOIEOIU ERPOIEOIU EOIU EPEPEP0P0P0P0P0P \n(P0P0PUOIY QEYUE6UI EP0P0PUOIY QEYUEIUY) x2";
